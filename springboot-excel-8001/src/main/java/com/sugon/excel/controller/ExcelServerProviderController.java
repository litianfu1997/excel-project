...
public class ExcelServerProviderController {
    ...
    //获取excel表格数据类型
    private Map<String, String> excelCellsType = null;
    ...
    public ResultEntity test() {
        ...
        System.out.println(appTestName);
...
//                            Integer.valueOf((int)sheetRow.getCell(col).getNumericCellValue())
    ...
    public synchronized ResultEntity selectSheetAllRow(String excelFile) {
    ...
    public synchronized ResultEntity selectRowByAnyKeys(@RequestBody Map<String, Object> entityMapData) {
